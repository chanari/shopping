                ...
                <ol class="checkout-steps">
                  ...
                  <li class="steps active">
                    ...
                    <div class="step-description">
                        <f:form action="${pageContext.request.contextPath}/edit" method="post" commandName="userEntity">
                        <div class="row">
                          <div class="col-md-6 col-sm-6">
                            <div class="your-details">
                              ...
                              <div class="form-row">
                                  <f:input cssClass="input namefild" path="id" hidden="true"/>
                                ...
                                <f:input cssClass="input namefild" path="firstname" readonly="true"/>
                              </div>
                              <div class="form-row">
                                <label class="lebel-abs">
                                  Last Name 
                                ...
                                <f:input cssClass="input namefild" path="lastname" readonly="true"/>
                              </div>
                              <div class="form-row">
                                <label class="lebel-abs">
                                  Email 
                                ...
                                <f:input cssClass="input namefild" path="email" readonly="true"/>
                              </div>
                              <div class="form-row">
                                <label class="lebel-abs">
                                  Phone
                                ...
                                <f:input cssClass="input namefild" path="phone" readonly="true"/>
                              </div>
                                <div class="form-row">
                                <label class="lebel-abs">
                                  Your Address 
                                ...
                                <f:input cssClass="input namefild" path="address" readonly="true"/>
                              </div>
                              <div class="pass-wrap">
                                  <c:if test="${empty ac}">
                                <div class="form-row">
                                  ...
                                  <f:input type="password" cssClass="input namefild" path="password" readonly="true"/>
                                </div>
                                  </c:if>
                              </div>
                                  <c:if test="${empty ac}">
                        ...
                        <c:if test="${not empty ac}">
                            <button onclick="location.href = '${pageContext.request.contextPath}/checkout'">
                                Checkout Now
                            </button>
                        </c:if>
                      ...
                      <c:if test="${empty ac}">
                      <h2 style="text-align: center; margin-bottom: 20px; margin-top: 20px">Your Orders History</h2>
                      <table class="table">
                    <thead>
                      <tr>
                        <th scope="col">#</th>
                    ...
                    <tbody>
                        <c:forEach var="o" items="${lstD}" >
                      <tr>
                          <th class="counterCell"></th>
                        <td>OD${o.ordersEntity.id}</td>
                        <td>${o.ordersEntity.orderDate}</td>
                      
                        
                        <td>${o.productEntity.productname}</td>
                        <td>$${o.price}</td>
                        <td>${o.quantity}</td>
