                ...
                <ol class="checkout-steps">
                  ...
                  <li class="steps active">
                    ...
                    <div class="step-description">
                        <f:form action="${pageContext.request.contextPath}/add-edit" method="post" commandName="userEntity">
                        <div class="row">
                          <div class="col-md-6 col-sm-6">
...
<!--                                <label class="lebel-abs">
                                ...
                                <input type="text" class="input namefild" name="lastname" value="${user.lastname}">-->
                              ...
                              <div class="form-row">
                                <f:label cssClass="lebel-abs" path="email" hidden="true">
                                  Email
                                  <strong class="red">
                                    *
                                  </strong>
                                </f:label>
                                  <f:input cssClass="input namefild" type="email" path="email" required="required" hidden="true"/>
                              </div>
                              <div class="form-row">
<!--                                <label class="lebel-abs">
                                  Phone
                                ...
                                <input type="text" class="input namefild" name="phone" value="${user.phone}">-->
...
<!--                                  <label class="lebel-abs">
                                  ...
                                  <input type="password" class="input cpass">-->
                                  <label class="lebel-abs" >
                                  Re-type Password 
                                  <strong class="red">
                                    *
