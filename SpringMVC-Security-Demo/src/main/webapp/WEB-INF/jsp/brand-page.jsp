            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-2 col-sm-2">
                     <div class="logo"><a href="${pageContext.request.contextPath}"><img src="${pageContext.request.contextPath}/resources/images/logo.png" alt="FlatShop"></a></div>
                  </div>
              ...
              <div class="banner">
                <div class="bannerslide" id="bannerslide">
                  <ul class="slides">
                    <li>
                      <a href="#">
                        <img src="http://localhost:8084/SpringMVC-Security-Demo/resources/images/banner-01.jpg" alt=""/>
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="http://localhost:8084/SpringMVC-Security-Demo/resources/images/banner-02.jpg" alt                       </a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="products-list">
                ...
                <ul class="products-listItem">
                  <c:forEach var="p" items="${lstP}">
                      <li class="products">
                    <div class="thumbnail">
                      <a href="${pageContext.request.contextPath}/details/${p.id}"><img src="http://localhost:8084/SpringMVC-Security-Demo/${p.image}" alt="Product Name"></a>
                    </div>
                        ...
                        <ul class="brand_item">
                           <li>
                               <a href="<c:url value="/brand-envato"/>">
                                 <div class="brand-logo"><img src="${pageContext.request.contextPath}/resources/images/envato.png" alt=""></div>
                              </a>
                           </li>
                           <li>
                              <a href="<c:url value="/brand-themeforest"/>">
                                 <div class="brand-logo"><img src="${pageContext.request.contextPath}/resources/images/themeforest.png" alt=""></div>
                              </a>
                           </li>
                           <li>
                              <a href="<c:url value="/brand-photodune"/>">
                                 <div class="brand-logo"><img src="${pageContext.request.contextPath}/resources/images/photodune.png" alt=""></div>
                              </a>
                           </li>
                           <li>
                              <a href="<c:url value="/brand-activeden"/>">
                                 <div class="brand-logo"><img src="${pageContext.request.contextPath}/resources/images/activeden.png" alt=""></div>
                              </a>
                           </li>
                        </ul>
                     </li>
