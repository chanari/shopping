			...
			<div class="container">
				...
				<!--=== Page Content ===-->
                                ...
                                <div class="row" style="margin-bottom: 10px">
                                    <form action="searchu" class="form-inline">
                                        <label>Search by Email : </label><br>
                                        <input type="text" name="searchu" placeholder="Enter Email"class="input-width-xlarge"/>
                                        <input type="submit" value="" hidden="true" style="margin-bottom: 10px"/>
                                    </form>
                                </div>
				<div class="row">
					<!--=== Table with Footer ===-->
									...
									<tbody>
                                                                            <c:forEach var="p" items="${lstU}">
                                                                                <tr>
                                                                                    ...
                                                                                    <td>${p.password}</td>
                                                                                    <td>${p.phone}</td>
                                                                                    <c:if test="${p.roleid == 1}">
                                                                                        <td>User</td>
                                                                                    </c:if>
                                                                                    <c:if test="${p.roleid == 2}">
                                                                                        <td>Admin</td>
                                                                                    </c:if>
                                                                                    <c:if test="${not p.enabled}">
                                                                                        <td><a href="${pageContext.request.contextPath}/active/${p.id}"><span class="label label-danger">Blocked</span></a></td>
                                                                                    </c:if>
                                                                                    <c:if test="${p.enabled}">
                                                                                        
                                                                                        <td><a href="${pageContext.request.contextPath}/deactive/${p.id}"><span class="label label-success">Active</span></a></td>
                                                                                    </c:if>
                                                                                    <td>
                                                                                        <span class="btn-group">
                                                                                            <li><a href="<c:url value="/edit-user/${p.id}"/>" class="bs-tooltip" title="Edit" class="btn btn-xs"><i class="icon-pencil"></i></a></li>
                                                                                            <li><a href="<c:url value="/find-order/${p.id}"/>" class="bs-tooltip" title="Search"><i class="icon-search"></i></a> </li>
                                                                                        </span>
